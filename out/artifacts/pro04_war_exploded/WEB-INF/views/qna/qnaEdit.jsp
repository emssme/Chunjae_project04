                        ...
                        <div class="table-responsive project-list">
                            <table class="table project-table table-centered table-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="title" name="title" placeholder="${detail.title}" style="border: 1px solid #cbcbcb; width: 100%" required></td>
                                </tr>
                                <tr>
                            ...
                            <div class="btn-group float-right">
                                <a href="${path}/qna/list" class="btn btn-outline-info">목록</a>
