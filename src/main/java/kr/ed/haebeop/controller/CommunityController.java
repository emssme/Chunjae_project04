...
import kr.ed.haebeop.service.CommunityService;
...
public class CommunityController {
    ...
    public void imageUpload(HttpServletRequest request, HttpServletResponse response, MultipartHttpServletRequest multiFile, @RequestParam MultipartFile upload) throws Exception {
        ...
        try{
            ...
            //이미지 경로 생성
            String path = "D:\\kim\\project\\pro04\\pro04\\src\\main\\webapp\\resources\\upload\\community/";	// 이미지 경로 설정(폴더 자동 생성)
            ...
            String fileUrl = request.getContextPath() + "/community/ckImgSubmit?uid=" + uid + "&fileName=" + fileName; // 작성화면
