...
public class PaymentController {
    ...
    public String paymentPro(HttpServletRequest request, RedirectAttributes rttr, HttpSession session) throws Exception {
        ...
        payment.setId(id);
        payment.setTcode(Integer.parseInt(request.getParameter("tcode")));
        ...
        if(pno > 0) {
            ...
            serve.setSprice(Integer.parseInt(request.getParameter("sprice")));
            serve.setAmount(Integer.parseInt(request.getParameter("amount")));
