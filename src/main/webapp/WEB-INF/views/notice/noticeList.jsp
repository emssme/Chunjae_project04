...
<div class="course_details_area mb-5 mt-5">
    ...
    <div class="container">
        <div class="col-xl-4 col-md-6 float-right mb-20"  style="z-index: 10">
            <form action="${path}/notice/list" method="get" class="ml-4">
                    ...
                    <div class="table-responsive project-list">
                        ...
                        <div class="pt-3">
                            <ul class="pagination justify-content-center mb-0">
                                ...
                                <li class="mr-2">
                                    <a href="${path}/notice/list?page=${page.blockLastNum + 1}" class="page-item"><i class="fa-solid fa-arrow-right"></i></a>
                                </li>
                                </c:if>
                            </ul>
                        </div>
