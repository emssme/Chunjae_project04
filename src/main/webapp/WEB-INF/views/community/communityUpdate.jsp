...
<head>
    ...
    <style>
        ...
        table th {width: 10%;vertical-align: middle;}
    </style>
...
<div class="course_details_area mb-5 mt-5">
    <div class="container">
        <!-- 테이블 영역 시작 -->
        <form action="${path}/community/edit" method="post" enctype="multipart/form-data">
            <div class="col-12">
                        ...
                        <div class="table-responsive project-list">
                            <table class="table project-table table-centered table-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="title" name="title" placeholder="제목을 입력하세요" style="border: 1px solid #cbcbcb; width: 100%; border-radius: 5px;" required value="${detail.title}"></td>
                                </tr>
                                <tr>
                                    <td colspan="6" style="font-size: 15px;">
                                        <textarea name="content" id="content" cols="100" rows="8" maxlength="1400" class="single-textarea" placeholder="내용을 입력하세요" style="height: 400px; border: 1px solid #cbcbcb; border-radius: 5px;">${detail.content}</textarea>
                                        <script>
